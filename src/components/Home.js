...
//The ref callbacks can be replaced with React.createRef() in newer versions (16.3+)
...
class Home extends Component {
  ...
  handleSubmit= (e) => {
      ...
      let teacherTopics = this.topic.value;
      let path = `teachers/${teacherTopics}/${teacherName}`;
  ...
  render() {
    return (
      <div className="main-content home">
        ...
        <Link to="/404">404 Page Example</Link>
        <hr />
        <h3>Featured Teachers</h3>
        {/*<Link to="teachers/Javascript/Andrew-Keith">Andrew Keith</Link>*/}
